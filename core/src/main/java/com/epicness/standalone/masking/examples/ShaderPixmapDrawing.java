...
public class ShaderPixmapDrawing extends Game {
    ...
    public void create() {
        ...
        FileHandle vertexShader = Gdx.files.internal("alejandria/showcase/shaders/shared/vertex.vert");
        FileHandle fragmentShader = Gdx.files.internal("alejandria/showcase/shaders/masking/mask.frag");
